...
//	static public final int MAX_STRINGREF_LENGTH = 64;
	...
	private int startNewSlidingNameSpaceCapacity;
	...
	public CBORWriter tagSlidingRefNS( int indexCapacity, int itemLengthLimit )
	{
		writeTag( 0x102 );
		writeIntU( indexCapacity );
		if( itemLengthLimit > 0 ) writeIntU( itemLengthLimit ); else writeNull();

		this.startNewSlidingNameSpace = true;
		this.startNewSlidingNameSpaceCapacity = indexCapacity;
		this.startNewSlidingNameSpaceItemLimit = itemLengthLimit;
		return this;
	}
	...
	private void pushState( STATE state )
	{
		...
		if( this.startNewSlidingNameSpace )
		{
			this.index = new SlidingByteStringIndex( this.startNewSlidingNameSpaceCapacity, this.startNewSlidingNameSpaceItemLimit );
			this.startNewSlidingNameSpace = false;
		}
		if( this.startNewNameSpace )
		{
